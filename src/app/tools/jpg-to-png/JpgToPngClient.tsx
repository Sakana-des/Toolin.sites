      ...
      {files.length === 0 ? (
        ...
        >
          ...
          <p className="text-sm md:text-base font-bold text-slate-800 dark:text-slate-200">
            Tarik file JPG / JPEG ke sini, atau klik untuk memilih
          </p>
          <p className="mt-1 text-xs text-slate-400 dark:text-slate-500">
            Mendukung konversi banyak file sekaligus (bulk upload). Hasil berkualitas tinggi.
          </p>
        </div>
      ) : (
        /* Workspace list */
                ...
                <div className="flex items-center gap-3">
                  ...
                  {item.status === "completed" ? (
                    ...
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-red-50 dark:hover:bg-red-950/30 hover:border-red-200 dark:hover:border-red-900/50 hover:text-red-650 transition-colors"
